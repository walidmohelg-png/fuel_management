<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div>
        ...
        <div class="mt-4">
            ...
            <x-text-input id="authorized_person_email" class="block mt-1 w-full" type="email" name="authorized_person_email" :value="old('authorized_person_email')" />
        </div>
        ...
        <div class="mt-4">
            ...
            <p class="mt-1 text-sm text-gray-500">{{ __('يفضل أن تكون الصورة واضحة وبتنسيق JPG أو PNG') }}</p>
        </div>
    ...
    <div>
        ...
        <div class="mt-4">
            ...
            <x-text-input id="representative_phone" class="block mt-1 w-full" type="text" name="representative_phone" :value="old('representative_phone')" />
        </div>
        
        {{-- 7. بريد المندوب --}}
        <div class="mt-4">
            <x-input-label for="representative_email" :value="__('البريد الإلكتروني للمندوب')" />
            <x-text-input id="representative_email" class="block mt-1 w-full" type="email" name="representative_email" :value="old('representative_email')" />
        </div>
